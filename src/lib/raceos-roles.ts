...
export const roles: Record<RoleId, RoleConfig> = {
  trainer: {
    ...
    nav: [
      ...
      { label: "Profile", to: "/profile/trainer", icon: "profile" },
    ],
  ...
  groom: {
    ...
    nav: [
      ...
      { label: "Profile", to: "/profile/groom", icon: "profile" },
    ],
  ...
  vet: {
    ...
    nav: [
      ...
      { label: "Profile", to: "/profile/vet", icon: "profile" },
    ],
  ...
  owner: {
    ...
    nav: [
      ...
      { label: "Profile", to: "/profile/owner", icon: "profile" },
    ],
  ...
  manager: {
    ...
    nav: [
      ...
      { label: "Profile", to: "/profile/manager", icon: "profile" },
    ],
